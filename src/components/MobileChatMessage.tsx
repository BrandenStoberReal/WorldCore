...
export const MobileChatMessage = memo(function MobileChatMessage({
  msg,
  index = 0,
  characterAvatar,
  userAvatar,
  ...
  return (
    <div className="group relative flex flex-col">
      ...
      {/* Message body — long-press for actions */}
      <div
      ...
      >
        <div
          className={cn(
            'mes_text relative rounded-md px-3 py-2 text-xs leading-relaxed break-words',
