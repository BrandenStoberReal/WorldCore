        ...
        >
          <div className="relative flex items-center gap-1 px-1.5 py-0.5">
            <textarea
              ...
              rows={1}
              maxLength={32000}
              className="placeholder:text-muted-foreground/50 text-mobile-base flex max-h-40 min-h-5 flex-1 resize-none bg-transparent font-mono text-[11px] leading-tight outline-none disabled:opacity-50"
