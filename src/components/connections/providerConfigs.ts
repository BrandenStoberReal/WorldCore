...
function apiKeyField(registrationUrl?: string, placeholder = 'sk-...'): ProviderField {
  return {
    type: 'password',
    key: 'apiKey',
    label: 'API Key',
    placeholder,
    link: registrationUrl ? { text: 'Manage API Keys', url: registrationUrl } : undefined,
  };
}
...
export const TEXTGEN_PROVIDERS: Record<string, ProviderConfig> = {
  ...
  huggingface: {
    name: 'HuggingFace',
    type: 'textgen',
    fields: [apiKeyField('https://huggingface.co/settings/tokens', 'hf_...')],
    showUrl: true,
  ...
  dreamgen: {
    name: 'DreamGen',
    type: 'textgen',
    fields: [apiKeyField('https://dreamgen.com/app/settings/api', 'dg_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  mancer: {
    name: 'Mancer',
    type: 'textgen',
    fields: [apiKeyField('https://neuro.mancer.tech/profile/api-keys', 'mn_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  featherless: {
    name: 'Featherless',
    type: 'textgen',
    fields: [apiKeyField('https://featherless.ai/account', 'fl_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  togetherai: {
    name: 'TogetherAI',
    type: 'textgen',
    fields: [apiKeyField('https://api.together.xyz/settings/api-keys', 'to_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  infermaticai: {
    name: 'InfermaticAI',
    type: 'textgen',
    fields: [apiKeyField('https://infermaticai.com/settings/api-keys', 'inf_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
};
...
export const CHATCOMPLETION_PROVIDERS: Record<string, ProviderConfig> = {
  openai: {
    name: 'OpenAI',
    type: 'chatcompletion',
    fields: [apiKeyField('https://platform.openai.com/api-keys', 'sk-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  ...
  claude: {
    name: 'Claude',
    type: 'chatcompletion',
    fields: [apiKeyField('https://console.anthropic.com/settings/keys', 'sk-ant-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  groq: {
    name: 'Groq',
    type: 'chatcompletion',
    fields: [apiKeyField('https://console.groq.com/keys', 'gsk_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  makersuite: {
    ...
    type: 'chatcompletion',
    fields: [apiKeyField('https://aistudio.google.com/app/apikey', 'AIza...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  mistralai: {
    name: 'MistralAI',
    type: 'chatcompletion',
    fields: [apiKeyField('https://console.mistral.ai/api-keys/', 'mist-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  deepseek: {
    name: 'DeepSeek',
    type: 'chatcompletion',
    fields: [apiKeyField('https://platform.deepseek.com/api_keys', 'sk-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  cohere: {
    name: 'Cohere',
    type: 'chatcompletion',
    fields: [apiKeyField('https://dashboard.cohere.com/api-keys', 'ck_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  xai: {
    name: 'xAI (Grok)',
    type: 'chatcompletion',
    fields: [apiKeyField('https://console.x.ai/team/default/api-keys', 'xai-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  ai21: {
    name: 'AI21',
    type: 'chatcompletion',
    fields: [apiKeyField('https://studio.ai21.com/account/api-key', 'ai21-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  aimlapi: {
    name: 'AI/ML API',
    type: 'chatcompletion',
    fields: [apiKeyField('https://aimlapi.com/account/api-keys', 'aiml-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  fireworks: {
    name: 'Fireworks AI',
    type: 'chatcompletion',
    fields: [apiKeyField('https://fireworks.ai/account/api-keys', 'fw_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  chutes: {
    name: 'Chutes',
    type: 'chatcompletion',
    fields: [apiKeyField('https://chutes.ai/app/api-keys', 'cpk_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  electronhub: {
    name: 'Electron Hub',
    type: 'chatcompletion',
    fields: [apiKeyField('https://electronhub.com/settings/api-keys', 'eh_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  nanogpt: {
    name: 'NanoGPT',
    type: 'chatcompletion',
    fields: [apiKeyField('https://nanogpt.com/settings/api-keys', 'ng_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  cometapi: {
    name: 'CometAPI',
    type: 'chatcompletion',
    fields: [apiKeyField('https://cometapi.com/settings/api-keys', 'cmt_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  moonshot: {
    name: 'Moonshot AI',
    type: 'chatcompletion',
    fields: [apiKeyField('https://platform.moonshot.cn/console/api-keys', 'sk-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  zai: {
    name: 'Z.AI (GLM)',
    type: 'chatcompletion',
    fields: [apiKeyField('https://open.bigmodel.cn/usercenter/apikeys', 'zai-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
    supportsReverseProxy: true,
  },
  ...
  siliconflow: {
    name: 'SiliconFlow',
    type: 'chatcompletion',
    fields: [apiKeyField('https://cloud.siliconflow.cn/account/ak', 'sk-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  minimax: {
    name: 'MiniMax',
    type: 'chatcompletion',
    fields: [apiKeyField('https://platform.minimaxi.com/console/api-keys', 'mx_...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
  ...
  perplexity: {
    name: 'Perplexity',
    type: 'chatcompletion',
    fields: [apiKeyField('https://www.perplexity.ai/settings/api', 'pplx-...')],
    showModelSelector: true,
    connectLabel: 'Connect',
  },
...
export function sourcesForCategory(category: ProviderCategory): string[] {
  const dict = category === 'textgen' ? TEXTGEN_PROVIDERS : CHATCOMPLETION_PROVIDERS;
