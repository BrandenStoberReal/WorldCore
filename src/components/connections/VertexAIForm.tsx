  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={authMode}
          onValueChange={(v) => update({ authMode: v as VertexAIAuthMode })}
        >
      ...
      {/* Express Mode Config */}
      {authMode === "express" && (
        <div className="space-y-4 rounded-md border border-border/40 bg-muted/10 p-3">
          {/* API Key */}
          <div className="space-y-2">
            <Label>API Key</Label>
          ...
          <div className="space-y-2">
            ...
            <p className="text-[12px] text-muted-foreground/60">
              Project ID is only required when selecting regions other than the
              default (us-central1).
            </p>
          </div>
        </div>
      ...
      {authMode === "full" && (
        <div className="space-y-4 rounded-md border border-border/40 bg-muted/10 p-3">
          ...
          <div className="space-y-2">
            ...
            <Label className="text-muted-foreground/60 font-normal text-[12px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                aria-label={
                  showServiceAccount ? "Hide content" : "Show content"
                }
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                onValidateServiceAccount?.(config?.serviceAccountJson ?? "")
              }
