...
/**
 * Pre-baked forge aesthetic helpers — used throughout the redesigned UI.
...
/** Ember pulse on an interactive element — used on primary CTA hover */
...
/** Hammered iron plate background — used on cards + tiles */
export const hammeredPlate =
  "bg-card border border-border shadow-[inset_0_1px_0_0_color-mix(in_oklch,var(--foreground)_6%,transparent),inset_0_-1px_0_0_color-mix(in_oklch,var(--foreground)_4%,transparent)]";

/** Subtle sparkline-styled bottom edge for an element */
