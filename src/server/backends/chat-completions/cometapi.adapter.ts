...
export class CometapiAdapter implements ChatCompletionAdapter {
  source = "cometapi" as const

  async forwardRequest(req: ChatCompletionRequest): Promise<Response> {
    const url = (req.reverse_proxy as string | undefined) || "https://api.cometapi.com/v1/chat/completions"
