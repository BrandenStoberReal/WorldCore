...
export class AimlapiAdapter implements ChatCompletionAdapter {
  source = "aimlapi" as const

  async forwardRequest(req: ChatCompletionRequest): Promise<Response> {
    const url = (req.reverse_proxy as string | undefined) || "https://api.aimlapi.com/v1/chat/completions"
