...
export class DeepSeekAdapter implements ChatCompletionAdapter {
  source = "deepseek" as const

  async forwardRequest(req: ChatCompletionRequest): Promise<Response> {
    const url = (req.reverse_proxy as string | undefined) || "https://api.deepseek.com/v1/chat/completions"
