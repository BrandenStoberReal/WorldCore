...
export class GroupService {
  ...
  async update(userId: string, id: string, data: Partial<Group>): Promise<void> {
    ...
    if (data.allow_self_responses !== undefined)
      dbUpdate.allowSelfResponses = data.allow_self_responses;
    if (data.activation_strategy !== undefined)
      dbUpdate.activationStrategy = data.activation_strategy;
    ...
    if (data.generation_mode_join_prefix !== undefined)
      dbUpdate.genModeJoinPrefix = data.generation_mode_join_prefix;
    if (data.generation_mode_join_suffix !== undefined)
