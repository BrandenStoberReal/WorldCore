...
/**
 * Wraps a route handler with session→userId resolution. Opt-in per character
 * route — never installed at the app.ts dispatch level.
 *
 * Resolution order:
 ...
 *   3. `handler(req, user.id)` → Response
 */
